...
from AspExt.model_MATE_base import modelMATEBase


class modelMATE(modelMATEBase):
    ...
    def build_models(self):
        ...
        self.base_models['aspect_embedding'] = torch.nn.Embedding(
    ...
    def init_base_model_params(self):
        ...
        self.base_models['aspect_embedding'].weight = aspect_para
    ...
    def build_encoder(self, input_, mask_):
        ...
        attn_ = 0.5*torch.tanh(attn_.squeeze(1))
    ...
    def build_pipe(self):
        ...
        if self.args.task[-5:] == 'train':
            ...
            asp_emb = self.base_models['aspect_embedding'](asp)
    ...
    def get_embedding_weights(self):
        ...
        asp_emb = self.base_models['aspect_embedding'].weight
