...
# CNN coefficient
parser.add_argument('--cnn_kernel_size', default='3,5', help='---')
parser.add_argument('--cnn_kernel_nums', default='16,16', help='---')
# word2vec
...
# kmeans
parser.add_argument('--kmeans_seeds', type=int, default=1,
                    help='kmeans seeds.')
parser.add_argument('--n_clusters', type=int, default=8,
                    help='number of clusters.')
parser.add_argument('--n_keywords', type=int, default=20,
