...
parser.add_argument('--file_val', default='dev.txt', help='validation')
...
parser.add_argument('--src_len', type=int, default=100,
                    help='length source documents #sentence.')
parser.add_argument('--tgt_len', type=int, default=3,
                    help='length of target documents #sentence.')

parser.add_argument('--file_output', default='test_output.json',
                    help='test output file')
# For evaluation
parser.add_argument('--matching_beta', type=float, default=0.7,
                    help='threshhold token matching.')
parser.add_argument('--min_sent_len', type=int, default=5,
                    help='min sentence length.')
...
if args.task == "evaluate":
    from SumEXT.metrics.pyrouge_eval import run_pyrouge
    run_pyrouge(args)
